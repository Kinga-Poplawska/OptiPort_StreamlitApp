...
PORTFOLIO_SETTINGS = {
    ...
    "phi_simplex_N": 4,  # Grid density N for OptiPort phi-triple simplex (OptiPort mode); N=4 gives 15 triples
    "phi_simplex_N_heuristic": 4,  # Grid density N for Phase 5 heuristic solve loop (None = use phi_simplex_N)
    "sols_for_second_stage": "mixed",  # Solution mode: "free", "restricted", or "mixed"
    "use_epsilon_weights": False,
